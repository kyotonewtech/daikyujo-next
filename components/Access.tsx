    ...
    <section id="access" className="py-32 px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <div>
              <h3 className="font-shippori text-3xl font-bold mb-8 border-l-4 border-accent pl-4">園山大弓場</h3>
              <div className="space-y-6">
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-medium">〒605-0071 <br />京都市東山区円山町（円山公園内）</p>
                  </div>
                </div>
                <div className="flex items-start gap-5">
                  <div className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center flex-shrink-0 text-accent">
            ...
            <div className="border-t border-gray-200 pt-10">
              ...
              <ul className="space-y-6 text-gray-700">
                <li className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
                  <span className="font-bold whitespace-nowrap w-20 bg-gray-100 text-center py-1 text-xs rounded">電車</span>
                  <span>京阪本線「祇園四条駅」より徒歩約15分</span>
                </li>
                <li className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
                  <span className="font-bold whitespace-nowrap w-20 bg-gray-100 text-center py-1 text-xs rounded">バス</span>
                  <span>市バス「祇園」停留所より徒歩約10分</span>
                </li>
                <li className="flex flex-col sm:flex-row sm:items-start gap-2 sm:gap-6">
                  <span className="font-bold whitespace-nowrap w-20 bg-gray-100 text-center py-1 text-xs rounded mt-1">お車</span>
                  <span className="flex-1">専用駐車場はございません。<br className="hidden sm:block" />近隣のコインパーキングをご利用ください。</span>
                </li>
              </ul>
            </div>
          </motion.div>
